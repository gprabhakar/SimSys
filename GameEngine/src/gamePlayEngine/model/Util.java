...
import gamePlayEngine.view.ConversationBubble;
import gamePlayEngine.view.RoundedPanel;
...
public class Util {
	...
	public static JPanel hintPosition(Location location, Prop prop, int fixLocation) {
		JPanel jPanel = new JPanel();
	...
	public static JLabel labelPosition(Location location, Prop prop) {
		...
		case DDL:
			...
			//jPanel.setOpaque(true);
			break;
		case LMC: // Zac ZHANG: Added a new location for test game 3 Conversation Bubble
