...
import gamePlayEngine.menuFrame;
...
import gamePlayEngine.model.Act;
import gamePlayEngine.model.Quiz;
...
import gamePlayEngine.model.Backdrop;
import gamePlayEngine.model.If;
...
import gamePlayEngine.model.Scene;
import gamePlayEngine.model.Screen;
import gamePlayEngine.model.GameElementTimer;
					...
					try{ // Zac ZHANG: added "try" part to make sure programming still running
						...
						if (challengeStructure != null) {
							...
							try { // Zac ZHANG: added "try" part to make sure programming still running
								...
								List<gamePlayEngine.model.Timer> timers = GameModel
