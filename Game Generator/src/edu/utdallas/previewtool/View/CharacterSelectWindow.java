...
try { BufferedImage img1 = ImageHelper.getScaledImage(
ImageIO.read(new File(l.getName())), slider.getValue() / HUNDREDPOINTZERO);
pic.setIcon(new ImageIcon(img1));
 ...
 *
 * @param characterAsset the new character asset
 */
 ...
 *
 * @param charNames the new character choices
 */
