...
try {
BufferedImage img = ImageHelper.getScaledImage(ImageIO.read(
new File("Office, Classroom/Asst "
+ "Bitstrips and Composite images/play.png")), POINTFIVE);
...
@Override
public void actionPerformed(final ActionEvent arg0) {
soundPathString = SOUNDFOLDER
+ soundFolderString + list.getSelectedValue().toString();
AudioPlayer.stopAudio();
setVisible(false);
}
});
 ...
 *
 * @param soundString the new sound path string
 */
 ...
 *
 * @param folderPath the new sound folder path
 */
