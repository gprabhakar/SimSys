...
public class ScenePanel extends JPanel
{
	...
	public void displayAct(Act act) {
		...
		if(act.getLearningObjective() != null){
			...
			JLabel actLearningObjectives = new JLabel("<html><p style=\"text-align:left\">Learning Objectives provided by WDPI" + (act.getLearningObjective().get(0).getLearningObjective()) + "</p></html>");
