...
public class Screen
    ...
    /**
     * Data elements represent:
     * learningObjective: a list of LearningObjective types.
     */
    @XmlElement(name = "LearningObjective")
    private List<LearningObjectiveType> learningObjective;
    /**
     * challenge: a list of Challenge types (quizzes, etc).
     *
     */
     @XmlElement(name = "Challenge")
     private List<Challenge> challenge;
     /**
      *GameElement types: a list of game elements (buttons,
      * characters, information boxes, props).
      */
