...
import edu.utdallas.gamePlayEngine.model.ReadBehavior;
...
import edu.utdallas.gamePlayEngine.model.Timer;
...
public class ConversationBubble extends JLabel implements TimingTarget{
    ...
    public ConversationBubble(Prop prop) {
    	...
    	List<Timer> timers = GameModel.getGameModelObject().getGameConstants().getTimers();
		int timerValue = 0;
